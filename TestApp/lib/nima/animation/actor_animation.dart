...
class AnimationEventArgs
{
	...
	AnimationEventArgs(String name, ActorComponent component, int type, double keyframeTime, double elapsedTime)
	{
		_name = name;
...
class ActorAnimation
{
	...
	/*
								...
								keyFrameTime:toTime,
								elapsed:0*/
	void triggerEvents(List<ActorComponent> components, double fromTime, double toTime, List<AnimationEventArgs> triggerEvents)
	{
					...
					case PropertyTypes.Trigger:
						...
						if(idx == 0)
						{
							if(kfl > 0 && keyFrames[0].time == toTime)
							{
								...
								triggerEvents.add(new AnimationEventArgs(component.name, component, property.propertyType, toTime, 0.0));
							}
						}
						else
						{
