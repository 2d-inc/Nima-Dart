...
HashMap<int,InterpolationTypes> interpolationTypesLookup = new HashMap<int,InterpolationTypes>.fromIterables([0,1,2,3,4,5], [InterpolationTypes.Hold, InterpolationTypes.Linear, InterpolationTypes.Mirrored, InterpolationTypes.Asymmetric, InterpolationTypes.Disconnected, InterpolationTypes.Progression]);
...
abstract class KeyFrameWithInterpolation extends KeyFrame
{
	...
	static bool read(BinaryReader reader, KeyFrameWithInterpolation frame)
	{
		...
		switch(frame._interpolationType)
		{
			...
			frame._interpolator = ValueTimeCurveInterpolator.read(reader, frame._interpolationType);
			break;
